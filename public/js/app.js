  ...
  methods: {
    initMap: function initMap() {
      ...
      this.map = new google.maps.Map(document.getElementsByClassName('map-section__map')[0], {
        center: {
          lat: this.centreCoordinates.lat,
          lng: this.centreCoordinates.lng
        },
        zoom: this.centreCoordinates.zoom
      });
      this.map.addListener('click', function (event) {
        if (_this.addPointEnabled) {
          _this.addMarker(event.latLng);
          _this.saveCoordinates(event.latLng.lat(), event.latLng.lng());
        }
      });
    },
    ...
    saveCoordinates: function saveCoordinates(lat, lng) {
    ...
    loadSavedPoints: function loadSavedPoints() {
      var _this2 = this;
      fetch('/api/get-points').then(function (response) {
        return response.json();
      }).then(function (data) {
...
var _hoisted_3 = {
  "class": "map-section__button-content"
};
var _hoisted_4 = {
  key: 0,
  src: "/img/svg/map-pin-slash.svg",
  alt: "Pin"
};
var _hoisted_5 = {
  key: 1,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("section", _hoisted_1, [_hoisted_2, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    onClick: _cache[0] || (_cache[0] = function () {
      return $options.toggleAddPoint && $options.toggleAddPoint.apply($options, arguments);
    }),
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["map-section__add-point-button", {
      "btn-primary": !$data.addPointEnabled,
      "btn-danger": $data.addPointEnabled
    }])
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [$data.addPointEnabled ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("img", _hoisted_4)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("img", _hoisted_5)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.addPointEnabled ? 'Disable Pins' : 'Enable Pins'), 1 /* TEXT */)])], 2 /* CLASS */)]);
}
...
/* harmony import */ var C_Code_thovex_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,C_Code_thovex_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_MapComponent_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_MapComponent_vue_vue_type_template_id_2f302b28__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/MapComponent.vue"]])
/* hot reload */
if (false) {}
